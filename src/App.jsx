...
// Plaatsvervangende flesfoto per wijntype, gebruikt zolang er nog geen echte
// (AI-gegenereerde of eigen) foto is. Oranje wijn krijgt de witte fles — qua
// kleur het dichtste alternatief van de vier beschikbare plaatshouders.
const PLACEHOLDER_PHOTO = {
  red: "/placeholder-red.png",
  white: "/placeholder-white.png",
  rose: "/placeholder-rose.png",
  sparkling: "/placeholder-sparkling.png",
  orange: "/placeholder-white.png",
};
function photoForWine(w) {
  return w.bottlePhoto || PLACEHOLDER_PHOTO[w.type] || PLACEHOLDER_PHOTO.red;
}
  ...
  return (
    ...
    <div ref={cardRef} className="card-scene" onClick={() => onExpand(w.id)}>
      ...
      <div className={"card-flip" + (expanded ? " is-flipped" : "")}>
        {/* ---------- FRONT — poster: bottle photo (real or placeholder) ---------- */}
        <div className={"card-face card-front" + (empty ? " is-empty" : "")}>
          ...
          <div className="front-bottle-col">
            <img src={photoSrc} alt={w.wine} className="bottle-photo" />
            {onCardCamera && (
              <button
                className="front-camera-btn"
        ...
        <div className="card-face card-back">
          <div className="card-back-inner">
            ...
            {/* ---- Prijs ---- */}
            <div className="back-row">
              <div className="back-row-icon"><Tag size={18} /></div>
              <div className="back-row-body">
    ...
    return (
      <>
        ...
        <div className="seed-wine-banner">
          ...
          <img src={photoForWine(seedWine)} alt={seedWine.wine} className="seed-wine-photo" />
        </div>
    ...
    <div className="cellar-app">
      ...
      <style>{`
        ...
        .front-camera-btn {
          ...
          background: rgba(36,30,20,0.72); border: none;
          display: flex; align-items: center; justify-content: center;
          color: #FFF; cursor: pointer; box-shadow: 0 3px 10px rgba(36,30,20,0.3);
        }
        ...
        .back-row:first-of-type { padding-top: 18px; }
        .back-row-icon {
          width: 42px; height: 42px; border-radius: 50%; flex-shrink: 0;
          background: var(--bg); color: var(--ink);
          display: flex; align-items: center; justify-content: center;
        }
        .back-score-circle { font-size: 15px; font-weight: 700; }
